...
namespace Gameplay.Shooting
{
    ...
    public class ProjectileConfig : ScriptableObject, IIdentityItem<string>
    {
        ...
        [field: SerializeField, Min(0.01f)] public float DamageAmount { get; private set; } = 1f;
        [field: SerializeField, Min(0.01f)] public float Speed { get; private set; } = 1f;
        [field: SerializeField, Min(0.001f)] public float LifeTime { get; private set; } = 10.0f;
