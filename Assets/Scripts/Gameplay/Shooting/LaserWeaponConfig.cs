...
namespace Gameplay.Shooting
{
    ...
    public class LaserWeaponConfig : SpecificWeaponConfig
    {
        ...
        [field: SerializeField, Min(0.001f)] public float MaxActiveTime_M { get; private set; } = 0.001f;
        [field: SerializeField, Min(0.001f)] public float ActiveTime_K { get; private set; } = 0.001f;
